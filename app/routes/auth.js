...
module.exports = function(router, passport, io){
  ...
  router.get('/profile', isLoggedIn, function(req, res){
	...
	function authorize(credentials, requestData, callback) {
		var clientSecret = "Hw5i7jIO6J0c6wS1YQEQx2q5";
		var clientId = "542826481216-e5089ltore1k2oli3krao8oei5v61loi.apps.googleusercontent.com";
		var redirectUrl = "https://e82867b9.ngrok.io";
	...
	router.get('/player', function(req, res){
		...
		authorize("Hw5i7jIO6J0c6wS1YQEQx2q5", {'params': {'mine': 'true',
                   'maxResults': '25',
